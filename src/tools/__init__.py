...
from .notify import tools as _notify_tools, TOOL_MAPPING as _notify_map, CATEGORY as _notify_cat, TAG as _notify_tag
...
_modules = [
    ...
    (_notify_tools, _notify_map, _notify_cat, _notify_tag),
